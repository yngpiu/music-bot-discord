/**
 * @file BotClient.ts
 * @description Custom Discord client extended with additional managers and command collections.
 */
import {
...
export class BotClient extends Client {
   ...
   * @param {number} botIndex - The index identifying this bot configuration.
   */
